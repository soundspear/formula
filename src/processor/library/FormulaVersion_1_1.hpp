...
#ifndef FORMULA_PROCESSOR_FORMULAVERSION_1_1_INCLUDED
#define FORMULA_PROCESSOR_FORMULAVERSION_1_1_INCLUDED
...
namespace formula::processor::library {
    /**
     * This version adds BPM and Bar timestamp handling
     */
    class FormulaVersion_1_1 : public FormulaVersion {
    private:
    ...
    private:
        ...
        static constexpr char processBlockMonoSymbolName[] = "process_block_mono_1_1";
        static constexpr char processBlockStereoSymbolName[] = "process_block_stereo_1_1";
    };
}

#endif //FORMULA_PROCESSOR_FORMULAVERSION_1_1_INCLUDED
