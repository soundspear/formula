#define Vst3File64 "./Formula.vst3"
#define NoVst2 "1"
#define WebsiteUrl "https://soundspear.com/"
#define AppVer "0.1"
#define OutputFileName "formula_setup.exe"
#define AppFolderName "Formula"
#define AppName "Formula"
[Setup]
DisableDirPage=yes
